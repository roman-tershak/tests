package tests.jpainejb.jta.util;
...
public class Utils {
	...
	private static int commitCallNum = 0;
	...
	private static final class GenericInvocationHandler implements InvocationHandler {
		...
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			try {
				...
				if (method.getName().equals("commit") && (xaDataSource == null || 
						xaDataSource != null && xaDataSource instanceof PGXADataSource)) {
					System.out.println("\n\n\n\nIn commit\n\n\n\n");
					if (commitCallNum++ < 1) {
						Thread.sleep(5000);
