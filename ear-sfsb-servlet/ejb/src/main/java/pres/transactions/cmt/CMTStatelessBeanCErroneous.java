...
@Stateless(mappedName="CMTStatelessBeanCErroneous")
@TransactionManagement(TransactionManagementType.CONTAINER)
public class CMTStatelessBeanCErroneous extends AbstractBean {
	...
	public Object opp(Map<String, Object> params, GenericBeanInterface... nexts) throws Exception {
		...
		DBUtils.executeQuery(oracleConn, "SELECT * FROM WRONG_TABLE");
		oracleConn.close();
